...
import urlparse
from scrapy_proj.items import JobBoleArticleItem, ArticleItemLoader
...
class JobboleSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for post_node in post_nodes:
            ...
            yield Request(url=urlparse.urljoin(response.url, post_url), meta={"front_image_url":urlparse.urljoin(response.url, front_image_url)} , callback=self.parse_detail, dont_filter=True)
